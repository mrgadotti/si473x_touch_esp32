...
//  tft.println("Si4732 DSP RADIO");
//  tft.setCursor(7, 75);
//  tft.println("FIRM PE0MGB-PU2CLR");
//  tft.setCursor(7, 125);
//  tft.println("PCB THIAGO LIMA");
//  tft.setCursor(7, 200);
//  delay(100);
...
//=======================================================================================
  ...
  while (x == 0) {
    ...
    tft.setFreeFont(&Serif_bold_10);
    tft.setTextColor(TFT_GREEN, TFT_BLACK);
    tft.drawString("BAND : " + String(bandIdx) + "  " + String(band[bandIdx].bandName) , 150, 140);
    tft.drawString("SSB FILTER : " + String(bandwidthSSB[bwIdxSSB]) + " kHz", 150, 150);
    tft.drawString("AM FILTER : " + String(bandwidthAM[bwIdxAM]) + " kHz", 150, 160);
    tft.drawString("STEP : " + String(currentStep), 150, 170);
    int vsupply = analogRead(ENCODER_SWITCH);
    tft.drawString("Power Supply : " + String(((1.66 / 1850)*vsupply) * 2) + " V", 150, 180);
    tft.setFreeFont(NULL);
    tft.setFreeFont(&Serif_bold_10);
    tft.setTextColor(TFT_RED, TFT_BLACK);
    tft.drawString("FIRMWARE V4 BETA", 150, 205);
    tft.drawString("RICARDO, GERT, THIAGO", 150, 225);
    tft.setFreeFont(NULL);
